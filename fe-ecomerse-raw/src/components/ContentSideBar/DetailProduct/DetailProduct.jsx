...
function DetailProduct() {
    ...
    return (
        <div className={container}>
            ...
            <div className={boxFooter}>
                Brand: <span>{detailProduct?.brand?.name || detailProduct?.brandName || detailProduct?.brandId || 'N/A'}</span>
            </div>
            <div className={boxFooter}>
                Category: <span>{detailProduct?.category?.name || detailProduct?.categoryName || detailProduct?.categoryId || 'N/A'}</span>
            </div>
            <div className={boxFooter}>
