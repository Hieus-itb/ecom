            ...
            <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(260px, 1fr))', gap: 16}}>
              {brands.map((b)=> (
                <div key={b._id||b.id} style={{background:'#fff', borderRadius:16, padding:16, boxShadow:'0 4px 16px rgba(0,0,0,0.06)', textAlign:'center'}}>
                  <div style={{width:160, height:160, margin:'0 auto 12px', borderRadius:'50%', overflow:'hidden', background:'#f5f5f5', display:'flex', alignItems:'center', justifyContent:'center'}}>
                    {b.logo ? (
                      <img src={b.logo} alt={b.name} style={{maxWidth:'100%', maxHeight:'100%'}} />
                    ) : (
